...
function Navbar({ changeColor, colorModeIcon }: Props) {
  ...
  return (
    <div>
        ...
        <div className="flex space-x-6">
          <div className="hidden md:flex items-center space-x-6">
            ...
            <Dropdown
              title="EN"
              items={[
                { title: "EN", action: () => alert("asds") },
                { title: "NE", action: () => alert("asds") },
              ]}
            />
      ...
      <div
        className={`absolute transition-all duration-200 left-0 top-0 bottom-0 w-4/6 sm:w-3/6 md:w-1/6 bg-white shadow-xl p-5 ${
